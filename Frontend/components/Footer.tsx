    ...
    const linkSections = [
        {
            ...
            links: [
                ...
                { text: "Refund Policy", path: '/refund-policy', icon: null },
                { text: "Shipping Information", path: '/shipping-info', icon: null },
                { text: "Cancellation Policy", path: '/cancellation', icon: null },
            ]
        },
        {
            title: "CONTACT",
