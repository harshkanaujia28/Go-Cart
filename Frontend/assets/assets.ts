...
import { ClockIcon, HeadsetIcon, SendIcon } from "lucide-react";
...
export const dummyStoreData = { id: "store_1", userId: "user_1", name: "Happy Shop", description: "At Happy Shop, we believe shopping should be simple, smart, and satisfying. Whether you're hunting for the latest fashion trends, top-notch electronics, home essentials, or unique lifestyle products — we've got it all under one digital roof.", username: "happyshop", address: "3rd Floor, Happy Shop , New Building, 123 street , c sector , NY, US", status: "approved", isActive: true, logo: happy_store, email: "happyshop@example.com", contact: "+0 1234567890", createdAt: "2025-09-04T09:04:16.189Z", updatedAt: "2025-09-04T09:04:44.273Z", user: { id: "user_31dOriXqC4TATvc0brIhlYbwwc5", name: "Great Stack", email: "user.greatstack@gmail.com", image: gs_logo, } }
...
export const productDummyData = [
    ...
    },
    {
        ...
        description: "...",
        mrp: 50,
        offerPercent: 30,           // 30% OFF
        price: Math.round(50 * (1 - 30 / 100)), // 35
        images: [product_img2],
        storeId: "seller_1",
        inStock: true,
        store: dummyStoreData,
    ...
    },
    {
        ...
        description: "...",
        mrp: 70,
        offerPercent: 20,           // 20% OFF
        price: Math.round(70 * (1 - 20 / 100)), // 56
        images: [product_img4],
        storeId: "seller_1",
        inStock: true,
        store: dummyStoreData,
    ...
    },
    {
        ...
        description: "...",
        mrp: 49,
        offerPercent: 15,          // 15% OFF
        price: Math.round(49 * (1 - 15 / 100)), // 42
        images: [product_img5],
        storeId: "seller_1",
        inStock: true,
        store: dummyStoreData,
    ...
    },
    {
        ...
        description: "...",
        mrp: 89,
        offerPercent: 10,           // 10% OFF
        price: Math.round(89 * (1 - 10 / 100)), // 80
        images: [product_img7],
        storeId: "seller_1",
        inStock: true,
        store: dummyStoreData,
    ...
    },
    {
        ...
        description: "...",
        mrp: 99,
        offerPercent: 25,           // 25% OFF
        price: Math.round(99 * (1 - 25 / 100)), // 74
        images: [product_img8],
        storeId: "seller_1",
        inStock: true,
        store: dummyStoreData,
    ...
    },
    {
        ...
        mrp: 179,
        offerPercent: 30,           // 30% OFF
        price: Math.round(179 * (1 - 30 / 100)), // 125
    ...
    },
    {
        ...
        mrp: 199,
        offerPercent: 15,           // 15% OFF
        price: Math.round(199 * (1 - 15 / 100)), // 169
...
export const ourSpecsData = [
    ...
    { title: "7 Days easy Return", description: "Change your mind? No worries. Return any item within 7 days.", icon: ClockIcon, accent: '#FF8904' },
